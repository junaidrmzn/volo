...
export const anySidePanelMachineConfigBuilder = (
    ...
    new ResourceMachineConfigBuilder({
        ...
        .withSidePanel();
export const anySidePanelMachineConfig = (
    overwrites?: Partial<CreateListMachineOptions<TestResource>>,
    authorizationOverwrites?: Partial<AuthorizationOptions>
) => anySidePanelMachineConfigBuilder(overwrites, authorizationOverwrites).build();
