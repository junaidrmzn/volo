...
export const { CompoundComponent: TimeSchedulerRowNew, getCompoundComponent: getTimeSchedulerRows } =
...
export const TimeSchedulerNew: FCC<TimeSchedulerProps> = (props) => {
