...
export type MissionResourceCreate = Mission;

export type MissionResourceUpdate = Partial<MissionResourceCreate>;

export type MissionResource = MissionResourceUpdate & { id: string };

export const anyListItemMissionResource = (overwrites?: Partial<Mission>): Mission => ({
    id: "-1",
    flightNumber: "VC123",
