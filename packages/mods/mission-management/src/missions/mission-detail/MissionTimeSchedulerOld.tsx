...
type MissionTimeSchedulerOldType = {
    mission: Mission;
};

export const MissionTimeSchedulerOld = (props: MissionTimeSchedulerOldType) => {
    const { mission } = props;
        ...
        >
            ...
            {crewData &&
                crewData.map((crewMember: CrewMember) => {
                    return (
                        <TimeSchedulerRow key={crewMember.id}>
                            <TimeSchedulerRowLabel>
