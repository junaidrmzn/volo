...
const editProcedureRequest = (definitionId: string, procedureId: string): RequestOptions => ({
    path: term({
        generate: `/ftd/v2/definitions/${definitionId}/procedures/${procedureId}`,
        matcher: "\\/ftd\\/v2\\/definitions\\/[\\da-fA-F\\-]+\\/procedures\\/[\\da-fA-F\\-]+",
    }),
    method: "PATCH",
    headers: {
...
pactWith({ consumer: PACT_CONSUMER_FTD_UI, provider: PACT_PROVIDER_FTD_API }, (provider) => {
    test("updates a procedure", async () => {
        ...
        await provider.addInteraction({
            ...
            uponReceiving: "a request for updating a procedure in the v2 endpoint",
