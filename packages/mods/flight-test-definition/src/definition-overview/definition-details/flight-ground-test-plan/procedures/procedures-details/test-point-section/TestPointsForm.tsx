                ...
                <BulkResourceForm
                    ...
                    initialValues={testPoints.map((testPoint) => {
                        const values: InitialValues<TestPointsFormSchema> & { id: string } = {
                            ...
                            isApplicableForAgency: testPoint.isApplicableForAgency,
                            isApplicableForBuildUp: testPoint.isApplicableForBuildUp,
                            isApplicableForCertification: testPoint.isApplicableForCertification,
                            isApplicableForDevelopment: testPoint.isApplicableForDevelopment,
                            isApplicableForUnassigned: testPoint.isApplicableForUnassigned,
                        };
