...
export const TestPointFormControlGroup = (props: TestPointFormControlGroupProps) => {
    ...
    const Checkbox: TestPointFormControlGroupProps["FormControl"] = (props) => (
        <Box mt={2.5}>
            <FormControl showLabel={false} showFieldLabel={false} {...props} />
        </Box>
    );
        ...
        <TestPointFormLayout>
            ...
            <TestPointFormLayout.Checkboxes>
                <TestPointFormLayout.Checkbox>
                    <Checkbox fieldName="isApplicableForDevelopment" />
                </TestPointFormLayout.Checkbox>
                <TestPointFormLayout.Checkbox>
                    <Checkbox fieldName="isApplicableForCertification" />
                </TestPointFormLayout.Checkbox>
                <TestPointFormLayout.Checkbox>
                    <Checkbox fieldName="isApplicableForAgency" />
                </TestPointFormLayout.Checkbox>
                <TestPointFormLayout.Checkbox>
                    <Checkbox fieldName="isApplicableForBuildUp" />
                </TestPointFormLayout.Checkbox>
                <TestPointFormLayout.Checkbox>
                    <Checkbox fieldName="isApplicableForUnassigned" />
                </TestPointFormLayout.Checkbox>
            </TestPointFormLayout.Checkboxes>
        </TestPointFormLayout>
    );
