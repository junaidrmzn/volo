        ...
        reservations: [
            {
                ...
                startDateTime: someDate.toISOString(),
                endDateTime: add(someDate, { minutes: 30 }).toISOString(),
                ...
                reservationModel: {
                    ...
                    scheduledDepartureDateTime: someDate.toISOString(),
                    scheduledArrivalDateTime: add(someDate, { minutes: 30 }).toISOString(),
            ...
            },
            {
                ...
                startDateTime: sub(someDate, { hours: 1 }).toISOString(),
                endDateTime: add(someDate, { days: 2 }).toISOString(),
                alternativeIdentifier: "VC-01",
                reservationModel: {
