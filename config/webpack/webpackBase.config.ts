...
export type WebpackBaseConfigurationOptions = {
    rootPath: string;
    bundleEntryFilePath?: string;
    babelConfigFilePath?: string;
};
export const webpackBaseConfiguration = (options: WebpackBaseConfigurationOptions): Configuration => {
    const {
        rootPath,
        bundleEntryFilePath = resolve(rootPath, "src/index.tsx"),
        babelConfigFilePath = resolve(rootPath, "config", "babel.config.js"),
    } = options;
